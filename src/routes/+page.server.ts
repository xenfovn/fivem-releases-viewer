...
export const load: PageServerLoad = async ({ fetch, setHeaders, url }) => {
	try {
		...
		console.log(`🔍 Processing ${filteredTopics.length} topics (Cache size: ${apiCache.size()})`);
		...
		console.log(`✅ Processed ${allTopics.length} topics (previews will be fetched on-demand)`);
